    ...
    return (
      <div className='min-h-screen bg-gray-900 text-white p-8'>
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='mb-10'>
            <h2 className='text-2xl font-semibold mb-4'>1. Instalar Tailwind CSS</h2>
            <p className='mb-4'>Instalar <code className='bg-gray-800 p-1 rounded'>TailwindCSS</code> y crear el archivo <code className='bg-gray-800 p-1 rounded'>tailwind.config.js</code></p>
            <div className='bg-gray-800 p-4 rounded'>
              ...
              <div className='flex justify-end mt-2'>
                ...
                {this.state.copiedText === 'npm install -D tailwindcss postcss autoprefixer\nnpx tailwindcss init' && <span className='ml-4 text-green-500'>¡Copiado!</span>}
              </div>
            </div>
          </div>
          ...
          <div className='mb-10'>
            ...
            <p className='mb-4'>Añade <code className='bg-gray-800 p-1 rounded'>TailwindCSS</code> y <code className='bg-gray-800 p-1 rounded'>autoprefixer</code> a tu archivo <code className='bg-gray-800 p-1 rounded'>postcss.config.js</code>.</p>
            <div className='bg-gray-800 p-4 rounded'>
              <pre>
                <code>
                  {'export default {\n  plugins: {\n    tailwindcss: {},\n    autoprefixer: {}\n  }\n}'}
          ...
          <div className='mb-8'>
            ...
            <p className='mb-4'>Añade las rutas para el uso correcto de Tailwind en tu archivo <code className='bg-gray-800 p-1 rounded'>tailwind.config.js</code>.</p>
            <div className='bg-gray-800 p-4 rounded'>
              <pre>
                <code>
          ...
          <div className='mb-8'>
            ...
            <p className='mb-4'>Descarga el archivo <code className='bg-gray-800 p-1 rounded'>index.css</code> que contiene todos los estilos propios, y luego pegalo en tu carpeta de estilos.</p>
            <a
              href='/index.css'
              download='index.css'
          ...
          <div className='mb-10'>
            ...
            <p className='mb-4'>Instala la dependencia de <code className='bg-gray-800 p-1 rounded'>Flowbite React</code>a tu proyecto.</p>
            <div className='bg-gray-800 p-4 rounded'>
              <pre>
                <code>
          ...
          <div className='mb-8'>
            ...
            <p className='mb-4'>Añade las rutas para el uso correcto de <code className='bg-gray-800 p-1 rounded'>Flowbite React</code> en tu archivo <code className='bg-gray-800 p-1 rounded'>tailwind.config.js</code>.</p>
            <div className='bg-gray-800 p-4 rounded'>
              <pre>
                <code>
              ...
              <div className='flex justify-end mt-2'>
                ...
                {this.state.copiedText === `const flowbite = require('flowbite-react/tailwind')\n/** @type {import('tailwindcss').Config} */\nexport default {\n  content: [\n    './src/**/*.{js,jsx,ts,tsx}',\n    'node_modules/flowbite-react/**/*.{js,jsx,ts,tsx}',\n    flowbite.content()\n  ],\n  theme: {\n    extend: {}\n  },\n  plugins: [flowbite.plugin()]` && <span className='ml-4 text-green-500'>¡Copiado!</span>}
              </div>
            </div>
          </div>

          <div className='mb-10'>
            <h2 className='text-2xl font-semibold mb-4'>7. Cruzar los dedos</h2>
          </div>
        </div>
      </div>
    );
